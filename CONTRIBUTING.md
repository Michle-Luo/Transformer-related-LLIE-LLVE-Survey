...
- Otherwise use **To be checked**.

## Handle uncertain links and metadata

- Do not guess paper links, code links, venue names, years, or dataset URLs.
- Preserve **To be checked** for unverified entries.
- Replace **To be checked** only after confirmation from reliable sources.

## Content restrictions

Do not add:

- copyrighted PDF copies
- copied figures
- dataset files
- pretrained weights
- local path references
- unrelated scripts or generated website artifacts

## Writing style

- Keep writing concise, formal, and academically neutral.
- Use one concise sentence for notes or method summaries where possible.
- Avoid promotional wording and unsupported performance claims.
